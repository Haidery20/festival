            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => handleInputChange("modelDescription", v)}
                >
                  <SelectTrigger>
              ...
              <div key={item.id} className="flex items-start space-x-2 mb-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange(item.id as keyof RegistrationData, checked as boolean)
                  }
                />
                <Label htmlFor={item.id} className="text-sm leading-relaxed">
                  {item.text} <span className="text-destructive">*</span>
                </Label>
              </div>
            ))}
          </div>
